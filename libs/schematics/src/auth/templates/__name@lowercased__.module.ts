...
import { UserModule } from '@realworld/user';
import { AUTH_MODULE_OPTIONS } from './__name@lowercased__.constants';
import { AuthService } from './__name@lowercased__.service';
import { AuthModuleAsyncOptions, AuthOptionsFactory } from './interfaces/__name@lowercased__-options.interface';
...
export class AuthModule {
  static registerAsync(options: AuthModuleAsyncOptions): DynamicModule {
    ...
    return {
      ...
      providers: [
        ...providers,
        AuthService, LocalStrategy, JwtStrategy, JwtRefreshStrategy, PublicStrategy
      ],
      exports: [AuthService],
    };
  }
